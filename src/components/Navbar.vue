            ...
            <transition name="dropdown">
              <div class="dropdown__menu" v-bind:class="{ active: show }" v-if="show">
                <ul class="dropdown__menu-nav">
                  ...
                  <!---------->
                  <li class="dropdown__menu-item">
                    <router-link to="/Personal_Info" class="router-link-style">
                      <a class="dropdown__menu-link" title="Personal info">
                        <div class="dropdown__menu-svg">
                  ...
                  <!---------->
                  <li class="dropdown__menu-item">
                    <router-link to="/Projects" class="router-link-style">
                      <a class="dropdown__menu-link" title="Projects">
                        <div class="dropdown__menu-svg">
                          <svg viewBox="1 1 18 18">
                            <path fill="currentColor" d="M17.283,5.549h-5.26V4.335c0-0.222-0.183-0.404-0.404-0.404H8.381c-0.222,0-0.404,0.182-0.404,0.404v1.214h-5.26c-0.223,0-0.405,0.182-0.405,0.405v9.71c0,0.223,0.182,0.405,0.405,0.405h14.566c0.223,0,0.404-0.183,0.404-0.405v-9.71C17.688,5.731,17.506,5.549,17.283,5.549 M8.786,4.74h2.428v0.809H8.786V4.74z M16.879,15.26H3.122v-4.046h5.665v1.201c0,0.223,0.182,0.404,0.405,0.404h1.618c0.222,0,0.405-0.182,0.405-0.404v-1.201h5.665V15.26z M9.595,9.583h0.81v2.428h-0.81V9.583zM16.879,10.405h-5.665V9.19c0-0.222-0.183-0.405-0.405-0.405H9.191c-0.223,0-0.405,0.183-0.405,0.405v1.215H3.122V6.358h13.757V10.405z" />
                          </svg>
                        </div>
                        <div class="dropdown__menu-text">Projects</div>
                      </a>
                    </router-link>
                  </li>
                  <!---------->
                  <li class="dropdown__menu-item">
                    <a class="dropdown__menu-link" title="Work &amp; Video">
                      <div class="dropdown__menu-svg">
                        <svg viewBox="1 1 18 18">
                          <path fill="currentColor" d="M18.175,4.142H1.951C1.703,4.142,1.5,4.344,1.5,4.592v10.816c0,0.247,0.203,0.45,0.451,0.45h16.224c0.247,0,0.45-0.203,0.45-0.45V4.592C18.625,4.344,18.422,4.142,18.175,4.142 M4.655,14.957H2.401v-1.803h2.253V14.957zM4.655,12.254H2.401v-1.803h2.253V12.254z M4.655,9.549H2.401V7.747h2.253V9.549z M4.655,6.846H2.401V5.043h2.253V6.846zM14.569,14.957H5.556V5.043h9.013V14.957z M17.724,14.957h-2.253v-1.803h2.253V14.957z M17.724,12.254h-2.253v-1.803h2.253V12.254zM17.724,9.549h-2.253V7.747h2.253V9.549z M17.724,6.846h-2.253V5.043h2.253V6.846z" />
                        </svg>
                      </div>
                      <div class="dropdown__menu-text">Work &amp; Video</div>
                    </a>
                  </li>
                  <!---------->
                  <li class="dropdown__menu-item">
                    <a class="dropdown__menu-link" title="Sharing">
                      <div class="dropdown__menu-svg">
                      ...
                      <div class="dropdown__menu-text">Sharing</div>
                    </a>
                  </li>
                  <!---------->
                  <li class="dropdown__menu-item">
                    <a class="dropdown__menu-link" title="Contact">
                      <div class="dropdown__menu-svg">
                        <svg viewBox="2 2 16 16">
                          <path fill="currentColor" d="M17.388,4.751H2.613c-0.213,0-0.389,0.175-0.389,0.389v9.72c0,0.216,0.175,0.389,0.389,0.389h14.775c0.214,0,0.389-0.173,0.389-0.389v-9.72C17.776,4.926,17.602,4.751,17.388,4.751 M16.448,5.53L10,11.984L3.552,5.53H16.448zM3.002,6.081l3.921,3.925l-3.921,3.925V6.081z M3.56,14.471l3.914-3.916l2.253,2.253c0.153,0.153,0.395,0.153,0.548,0l2.253-2.253l3.913,3.916H3.56z M16.999,13.931l-3.921-3.925l3.921-3.925V13.931z" />
                        </svg>
                      </div>
                      <div class="dropdown__menu-text">Contact</div>
                    </a>
                  </li>
                </ul>
              </div>
...
.dropdown__menu {
  ...
  filter:drop-shadow(-1px 1px 1.5px rgba(12, 12, 12, 0.9));
  &-link {
    display: flex;
    align-items: center;
    ...
    &:hover {
      color: #ffad1f;
      background-color: rgba(192, 152, 79, 0.1);
    };
  }
  &-svg {
    width: 1.5rem;
